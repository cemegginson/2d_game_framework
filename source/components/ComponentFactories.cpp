...
//
// Carrier* CarrierFactory::Create(Actor2D* owner, pugi::xml_node node) {
//     UNUSED(node);
...
//
// Infantry* InfantryFactory::Create(Actor2D* owner, pugi::xml_node node) {
//     UNUSED(node);
...
RigidCircle* RigidCircleFactory::Create(Actor2D* owner, pugi::xml_node node) {
